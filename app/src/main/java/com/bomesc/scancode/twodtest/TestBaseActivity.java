...
public class TestBaseActivity extends Activity implements DecoderManager.IDecoderStatusListener{
    ...
    DecoderManager mDecoderMgr = null;//向应用程序提供解码器API
    ...
    class LightControlHandler extends Handler{  //Handle是用来结合线程的消息队列来发送、处理“Message对象”和“Runnable对象”的工具
        public void handleMessage(android.os.Message msg) {
            //Log.d(TAG, "lightControlHandler msg.what = " + msg.wFhat + " mDecoderMgr = " + mDecoderMgr);
            //if(mDecoderMgr != null){
    ...
    protected void onResume() {
        ...
        isOnResume = true;
        scanCase = 0;
        int res = mDecoderMgr.connectDecoderSRV();//连接到解码器服务器，准备扫描
