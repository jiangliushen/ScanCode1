...
package com.bomesc.scancode.twodtest;
...
import com.bomesc.scancode.io.SaveFileToSDCard ;
...
public class ScanTestActivity extends TestBaseActivity implements OnCheckedChangeListener{
    ...
    private static final int STARTCONTINUESHOOT = 1;//开始连续扫描
    private static final int STOPCONTINUESHOOT = 2; //终止连读扫描
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 0:
                    ...
                    mScanTotalTextView.setText(getString(R.string.scan_total) + ScanTotalNum);//扫描次数
                    break;
                case 1:
                    Toast.makeText(ScanTestActivity.this, R.string.save_success, Toast.LENGTH_SHORT).show();//保存成功
                    enableSaveFile = true;
                    break;
                case 2:
                    Toast.makeText(ScanTestActivity.this, R.string.save_fail, Toast.LENGTH_SHORT).show();//保存失败
                    enableSaveFile = true;
                    break;
                default:
                    break;
...
//        mScanLightController.enableLoc2ationLight(false);
